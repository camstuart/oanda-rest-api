...
Report bugs at https://github.com/camstuart/oanda-rest-api/issues
...
https://github.com/camstuart/oanda-rest-api/issues.
...
Ready to contribute? Here's how to set up `oanda-rest-api` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `oanda-rest-api` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/oanda-rest-api.git
